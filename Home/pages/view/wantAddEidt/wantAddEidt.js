...
Page({
  ...
  onLoad: function (options) {
    ...
    var checkboxItems = {
      hydropower: [ //水电工程增项
        { name: '是否存在中央空调6平方外机线或者4平方内机线增项；', value: '0' },
